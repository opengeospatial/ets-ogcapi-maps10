...
As entry point the API landing page of an OGC API - Maps instance is expected.

=== 1. Integrated development environment (IDE)

Use a Java IDE such as Eclipse, NetBeans, or IntelliJ. Clone the repository and build the project.

Set the main class to run: `org.opengis.cite.ogcapimaps10.TestNGController`
...
`java -jar ets-ogcapi-maps10-${version}-aio.jar [-o|--outputDir $TMPDIR] [-h|--generateHtmlReport] [test-run-props.xml]`
...
You need to retrieve the https://hub.docker.com/r/ogccite/ets-ogcapi-maps10[image from Docker Hub] by running the following

    docker run -p 8081:8080 ogccite/ets-ogcapi-maps10
...
Choose 'OGC' organization then Specification 'OGC API - Maps - 1.0'
...
image::img/ogc-api-maps-conformance-test-suite-ogccite-05.png[]

Wait test execution and see the results from the validator

image::img/result-ogc-api-maps-test-suite-ogccite-06.png[]
