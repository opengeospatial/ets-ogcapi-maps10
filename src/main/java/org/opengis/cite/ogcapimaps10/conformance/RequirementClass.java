...
public enum RequirementClass {
	...
	CORE("http://www.opengis.net/spec/ogcapi-Maps-1/1.0/conf/core"),

	HTML("http://www.opengis.net/spec/ogcapi-Maps-1/1.0/conf/html", "text/html", "text/html"),

	GEOJSON("http://www.opengis.net/spec/ogcapi-Maps-1/1.0/conf/geojson", "application/geo+json", "application/json"),

	GMLSF0("http://www.opengis.net/spec/ogcapi-Maps-1/1.0/conf/gmlsf0",
			"application/gml+xml;version=3.2;profile=http://www.opengis.net/def/profile/ogc/2.0/gml-sf0",
			"application/xml"),

	GMLSF2("http://www.opengis.net/spec/ogcapi-Maps-1/1.0/conf/gmlsf2",
	...
	PROJECTION("https://www.opengis.net/spec/ogcapi-maps-1/1.0/conf/projection");
