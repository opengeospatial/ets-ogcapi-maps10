...
public enum SuiteAttribute {
	...
	/**
	 * Results from interactive tests for JPEG XL content verification. Contains boolean
	 * results for Part B (color image representation) and Part C (portrayal consistency).
	 */
	JPEGXL_INTERACTIVE_TEST_RESULT("jpegXlInteractiveTestResult", JpegXlInteractiveTestResult.class);
