...
public class TransparentParameterDefinition extends CommonFixture {
    ...
    /**
     * Ensures the SUT declares conformance to the required requirement classes.
     * If a requirement class is not declared, the test must be skipped (not failed).
     */
    ...
    private String getMapBaseUrlTemplate() throws Exception {
        ...
        throw new SkipException("Test Skipped: No map resources found in the collections to verify. Cannot proceed with A.7.");
    }
    ...
    private static void assertCornerAlpha(InputStream imageStream, int expectedAlpha, String assertionMessage) throws Exception {
    ...
    public void verifyTransparentDefinition() throws Exception {
        ...
        // ==========================================================
        System.out.println("\n[Case 2] transparent (absent) + bgcolor=" + testBgColor + " => expect transparent=false (alpha=255)");
        ...
        // Expectation: server interprets transparent as Boolean and makes background non-transparent
        // ==========================================================
