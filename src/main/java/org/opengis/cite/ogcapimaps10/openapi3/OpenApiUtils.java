...
import static org.opengis.cite.ogcapimaps10.openapi3.OpenApiUtils.PATH.COLLECTIONS;
import static org.opengis.cite.ogcapimaps10.openapi3.OpenApiUtils.PATH.CONFORMANCE;
...
public class OpenApiUtils {
	...
	public static List<TestPoint> retrieveTestPointsForCollections(OpenApi3 apiModel, URI iut, int noOfCollection) {
		...
		if (noOfCollection < 0 && allTestPoints.size() > OgcApiMaps10.COLLECTIONS_LIMIT) {
			return allTestPoints.subList(0, OgcApiMaps10.COLLECTIONS_LIMIT);
		}
