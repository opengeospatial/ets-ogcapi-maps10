 ...
 * verification of Abstract Test A.29 Req 29/E (datetime subset-definition CRS
 * interpretation).
 *
 * <p>
 ...
 * and represents data from approximately January 1, 2021, proving that the server
 * correctly interprets the Gregorian UTC time coordinate per Req 29/E.
 */
public final class DatetimeSubsetCrsInteractiveTestUtils {
	...
	private DatetimeSubsetCrsInteractiveTestUtils() {
	}

	/**
	 * Builds a map URL filtered to {@code subset=time("2021-01-01T00:00:00Z")}, used as
	 * the temporal snapshot for verifying correct CRS interpretation (Req 29/E).
	 ...
	 * verifying correct CRS interpretation (Req 29/E).
	 * @param landingPageUrl the API landing page URL
